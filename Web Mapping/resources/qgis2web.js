...
map.getView().fit([9154667.685824, 2946589.308340, 9633135.060508, 3378317.034800], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Airport WebMap</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (66 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'this is map showing pop of nepal and Airport<br />author:shivnandan<br /><br /><br /><br />';
            }
